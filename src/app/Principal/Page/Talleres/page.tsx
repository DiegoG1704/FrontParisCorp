...
export default function Page() {
    const {taller,ListaTaller}=useAppContext();
  ...
  return (
    <div className="flex flex-col p-10 bg-gray-50 min-h-screen">
      <Toast ref={toast} />
      <h1 className="text-[40px] text-[#4F9CD7] font-bold">Talleres de Confeccion</h1>
      ...
      <div className="flex flex-col lg:flex-row mt-10 justify-between gap-4">
        <InputText placeholder="Buscar por nombre o DNI..." className="h-12 w-full lg:w-[30rem]" />
        <div>
          <Button 
            icon='pi pi-refresh'
